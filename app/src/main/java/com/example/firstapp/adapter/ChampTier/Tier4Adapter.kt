 ...
 * @since 2021/11/10
 **/
class Tier4Adapter(val context: Context) : RecyclerView.Adapter<Tier4ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Tier4ViewHolder {
        ...
        return Tier4ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: Tier4ViewHolder, position: Int) {
        Glide.with(context)
...
class Tier4ViewHolder(val binding: ItemTierBinding) : RecyclerView.ViewHolder(binding.root) {
