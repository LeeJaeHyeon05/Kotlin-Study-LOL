 ...
 * @since 2021/11/10
 **/
class Tier3Adapter(val context: Context) : RecyclerView.Adapter<Tier3ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Tier3ViewHolder {
        ...
        return Tier3ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: Tier3ViewHolder, position: Int) {
        Glide.with(context)
...
class Tier3ViewHolder(val binding: ItemTierBinding) : RecyclerView.ViewHolder(binding.root) {
