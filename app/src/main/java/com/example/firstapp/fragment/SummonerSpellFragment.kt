...
class SummonerSpellFragment : Fragment() {
    override fun onCreateView(
        ...
        var rootView = inflater.inflate(R.layout.fragment_summoner_spell, container, false)

        val smite: ImageButton = rootView.findViewById(R.id.btn_smite)
        val tel: ImageButton = rootView.findViewById(R.id.btn_tel)
        val shield: ImageButton = rootView.findViewById(R.id.btn_Shield)
        val flash: ImageButton = rootView.findViewById(R.id.btn_flash)
        val heal: ImageButton = rootView.findViewById(R.id.btn_heal)
        val fire: ImageButton = rootView.findViewById(R.id.btn_fire)
        val clean: ImageButton = rootView.findViewById(R.id.btn_clean)
        val ghost: ImageButton = rootView.findViewById(R.id.btn_ghost)
        val exhausted: ImageButton = rootView.findViewById(R.id.btn_exhausted)
        val totheking: ImageButton = rootView.findViewById(R.id.btn_totheking)
        val throwforo: ImageButton = rootView.findViewById(R.id.btn_throwForo)
        val blue: ImageButton = rootView.findViewById(R.id.btn_blue)
        ...
        smite.setOnClickListener {
            ...
            dialogBuilder.setMessage("대상 에픽 및 대형/중형 몬스터, 혹은 적 미니언에게 450의 고정 피해를 입힙니다. 몬스터에게 사용 시 체력도 90 + 최대 체력의 10%만큼 회복됩니다.")
                ...
                .setCancelable(false)
                .setNegativeButton("계속 하기", DialogInterface.OnClickListener { dialog, _ ->
                    dialog.cancel()
                })
        ...
        ghost.setOnClickListener {
            ...
            dialogBuilder.setMessage(
                "챔피언이 10초 동안 유닛과 충돌하지 않게 되며 챔피언 레벨에 따라 이동 속도가 24 ~ 48% 증가합니다.\n" +
                        "\n" +
