 ...
 * @since 2021/11/10
 **/
class Tier5Adapter(val context: Context) : RecyclerView.Adapter<Tier5ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Tier5ViewHolder {
        ...
        return Tier5ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: Tier5ViewHolder, position: Int) {
        Glide.with(context)
...
class Tier5ViewHolder(val binding: ItemTierBinding) : RecyclerView.ViewHolder(binding.root) {
