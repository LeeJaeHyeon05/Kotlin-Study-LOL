 ...
 * @since 2021/11/10
 **/
class Tier1Adapter(val context: Context, val championDao: ChampionDao) : RecyclerView.Adapter<Tier1ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: Tier1ViewHolder, position: Int) {
        ...
        CoroutineScope(Dispatchers.Main).launch {
            val championName_en = translateToEn(championDao, championName)
            Glide.with(context)
